...
const STYLE_MAP = {
  ...
  'Programa COBOL (Batch)':         { border: 'blue-border',   icon: 'blue',    iconClass: 'file-code' },
  'Programa COBOL (Online)':        { border: 'blue-border',   icon: 'blue',    iconClass: 'device-desktop' },
  'Serviço (CICS)':                 { border: 'purple-border', icon: 'purple',  iconClass: 'settings' },
  'Serviço CICS':                   { border: 'purple-border', icon: 'purple',  iconClass: 'settings' },
  'Exec SQL / DB2':                 { border: 'slate-border',  icon: 'slate',   iconClass: 'database-search' },
  'Job de Exclusão / Expurgo':      { border: 'orange-border', icon: 'orange',  iconClass: 'file-x' },
  ...
  'Tela Web (Java / Python)':       { border: 'blue-border',   icon: 'blue',    iconClass: 'browser' },
  'API REST (Java / Python)':       { border: 'blue-border',   icon: 'blue',    iconClass: 'api' },
  'Chamada para Alta Plataforma':   { border: 'indigo-border', icon: 'indigo',  iconClass: 'arrow-up-right-circle' },
  ...
  'Geração de Carta / Documento':   { border: 'blue-border',   icon: 'blue',    iconClass: 'file-description' },
  'Transmissão a Bancos':           { border: 'purple-border', icon: 'purple',  iconImg: 'img/banco.png' },
  'Transmissão a Clientes':         { border: 'purple-border', icon: 'purple',  iconClass: 'users' },
  'Transmissão a Corretores':       { border: 'purple-border', icon: 'purple',  iconClass: 'briefcase' },
  'Transmissão a Corretoras':       { border: 'purple-border', icon: 'purple',  iconClass: 'briefcase' },
  ...
  try {
    if (window.showSaveFilePicker) {
      const handle = await window.showSaveFilePicker({
        suggestedName: 'fluxo-micro.json',
      ...
      _downloadJson(data, 'fluxo-micro.json');
    }
    _isDirty = false;
    _updateFooterSaved();
